...
borked_tests :: [Test]
borked_tests = [
    ([], [Top_Level_Const_Defn "c" (Just "Integer") (Leaf (LitChar 'a'))], Left (TypeError "Integer" "Char"), "char"),
    ([], [Top_Level_Const_Defn "c" Nothing (Signed (Leaf (LitChar 'a')) "Bool")], Left (TypeError "Integer" "Char"), "bad char")
    ]
