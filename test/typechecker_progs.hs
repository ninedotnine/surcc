...
conster =  program_header [
    TopLevelConstDefn (Identifier "n") notype (Leaf (Lit (LitInt 42)))]
...
int :: ParseTree
int =  program_header [
    TopLevelConstDefn (Identifier "n") (Just SoucInteger) (Leaf (Lit (LitInt 42)))]
...
fn = program_header [
    FuncDefn (Identifier "f") (Param  (Identifier "x") (Just SoucInteger)) notype (Stmts [
        Stmt_Return (Just (Leaf (Lit (LitInt 42))))])]
...
borked = program_header [
    TopLevelConstDefn (Identifier "n") (Just SoucInteger) (Leaf (Lit (LitChar 'a')))]
...
borked_fn = program_header [
    FuncDefn (Identifier "f") (Param  (Identifier "x") notype) (Just SoucInteger) (Stmts [
        Stmt_Return (Just (Leaf (Lit (LitChar 'a'))))])]
...
borked_import = ParseTree default_module [LibImport "x"] [] [
    TopLevelConstDefn (Identifier "x") (Just SoucInteger) (Leaf (Lit (LitInt 42)))]
