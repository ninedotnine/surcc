...
module SouC.Parser.Expr.ExprParser (
    parse_expression,
...
import SouC.Parser.Expr.StackManipulations
import SouC.Parser.Expr.Types
import SouC.Parser.Expr.RegardingSpaces
import SouC.Parser.Expr.Terms
import SouC.Parser.Expr.Opers
import SouC.Parser.Expr.Raw  (RawExpr)

import SouC.Common
import SouC.Common.Parsing (type_name, upper_name, optional_sig)
